...
//   return (
//     <AuthContext.Provider value={{ user, username: user ? user.username : null, login, register, logout }}>
//       {children}
//     </AuthContext.Provider>
//   );
// };
...
export const AuthProvider = ({ children }) => {
  ...
  return (
    <AuthContext.Provider value={{ user, userId: user ? user.id : null, username: user ? user.username : null, login, register, logout }}>
      {children}
    </AuthContext.Provider>
  );
};
